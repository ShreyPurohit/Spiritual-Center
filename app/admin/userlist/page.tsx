...
const EditDeleteButtons = dynamic(() => import('@/components/admin/UserEditDeleteButtons'))
const UserListPaginationButtons = dynamic(() => import('@/components/admin/UserListPaginationButtons'))
const UserSearchSortButtons = dynamic(() => import('@/components/admin/UserSearchAndSortButton'))
