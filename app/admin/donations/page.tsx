...
const PaidUsersComponent = dynamic(() => import('@/components/admin/PaidUsersComponent'))
const UnpaidUserComponent = dynamic(() => import('@/components/admin/UnpaidUserComponent'))
