...
const ChatAreaComponent = dynamic(() => import('@/components/chat/ChatAreaComponent'))
const ChatSideBarComponent = dynamic(() => import('@/components/chat/ChatSideBarComponent'))
